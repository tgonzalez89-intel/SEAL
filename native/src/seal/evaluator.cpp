...
namespace seal
{
        ...
        MemoryPoolHandle pool) const
    {
        ...
        if (scheme == scheme_type::ckks)
        {
            ...
            for (size_t i = 0; i < coeff_count * decomp_modulus_size * key_component_count; i++)
            {
            ...
            {
                for (size_t j = 0; j < key_modulus_size * coeff_count * key_component_count; j++)
                {
            ...
            for (size_t i = 0; i < coeff_count * decomp_modulus_size * key_component_count; i++)
            {
                js["expected_output"].push_back(encrypted.data()[i]);
            }
